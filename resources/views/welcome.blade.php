                    ...
                    <div class="rev_slider" id="slider1" data-version="5.0">
                        <ul>
                            ...
                            >
                                ...
                                <!-- HERO TITLE -->
                                <div style="" class="tp-caption hero-title rs-parallaxlevel-7"
                                     data-x="center"
                                     data-y="center"
                ...
                <div class="container">
                    <div class="animate">
                        <div class="animate-container">
                            <p class="intro__text text-center" style="text-align: right;">یک آژانس خلاق و دیجیتالی که متخصص خدمات مارک دار ، تجربیات و کمپین های دیجیتالی است. تیم ما به گونه ای انتخاب شده است که تعادل مناسب مهارت ها را برای کار فراهم کند</p>
                        </div>
                    </div>
                </div>
            </section> <!-- end intro -->
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="title-row animate">
                                <div class="animate-container">
                                    <h3 class="section-subtitle section-subtitle--line">خدمات ما</h3>
                                    <h2 class="section-title">اهداف دیجیتال</h2>
                                    <p class="section-description">راه حل های خلاقانه با
                                        تمرکز استراتژیک ما برندها را پرورش می دهیم ، تجربه ایجاد می کنیم و مشکلات تجاری را حل می کنیم.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="service" style="text-align: right">
                                                ...
                                                <p class="service__text" >چند سالی است که تجربه کاربری مورد توجه قرار گرفته است ، زیرا بسیاری از شرکت ها از طراحان UX تمام وقت استفاده می کنند یا با آژانس های طراحی UI/UX کار می کنند.</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="service"style="text-align: right">
                                                <i class="service__icon o-source-code-1"></i>
                                                <h4 class="service__title">Web&Application</h4>
                                                <p class="service__text">تولید انواع نرم افزار اپلیکیشن ، اپ موبایل اندروید و ایفون ، وب سایت، وب اپلیکیشن
                                                    امروزه نرم افزار ها دقت و سرعت انجام کارها را بالابرده و باعث کاهش خطاهای انسانی در انجام کارها می شوند</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6"style="text-align: right">
                                            <div class="service">
                                                ...
                                                <h4 class="service__title">Marketing Support</h4>
                                                <p class="service__text">منظور از پشتیبانی بازاریابی فضای تبلیغاتی ،  خدمات بازاریابی ، محصولات یا خدمات تبلیغاتی ، سایر داده ها یا تجزیه و تحلیلهای مشتق شده ، و سایر محصولات یا خدمات بازاریابی یا تبلیغاتی است</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-6"style="text-align: right">
                                            <div class="service">
                                                ...
                                                <p class="service__text">استراتژی بازاریابی خدمات بر ارائه فرایندها ، تجربیات و موارد نامشهود به مشتریان تمرکز دارد تا کالاها و معاملات فیزیکی. ... به طور معمول ، خدمات مشتری به طور مستقیم درآمد ایجاد نمی کند بلکه به درخواست ها ، سوالات و شکایات مشتریان ، علاوه بر ارائه پاسخ و راه حل ، پاسخ می دهد.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="animate">
                                <div class="animate-container">
                                    <div class="title-row mb-40">
                                        ...
                                        <h2 class="section-title">وب یونتی</h2>
                                        <p class="section-description">ما می خواهیم نشانه ی  تجاری شما را با محتوای باکیفیت که به شما در شناخته شدن  و رقابت کردن با کسب و کار های رقبای شما  کمک می کند ، بیان کنیم.</p>
                                    </div>
                                            ...
                                            <div class="accordion__panel">
                                                <div class="accordion__heading" id="heading-1">
                                                    <a data-toggle="collapse" href="#collapse-1" class="accordion__link accordion--is-open" aria-expanded="true" aria-controls="collapse-1">
                                                        ...
                                                        <h4 class="accordion__title"style="margin-right: 20px;">ما کی هستیم</h4>
                                                    </a>
                                                </div>
                                                <div id="collapse-1" class="collapse show" data-parent="#accordion-1" role="tabpanel" aria-labelledby="heading-1">
                                                    <div class="accordion__body">
                                                        <p>
                                                            ما مشتاق ایجاد و ارائه کار با کیفیت بالا ، پاسخگویی به نیازهای تجاری مشتریان و اطمینان از بهترین تجربه کاربری برای مشتریان آنها هستیم.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion__panel">
                                                <div class="accordion__heading" id="heading-2">
                                                    <a data-toggle="collapse" href="#collapse-2" class="accordion__link" aria-expanded="true" aria-controls="collapse-2">
                                                        <span class="accordion__toggle"></span>
                                                        <h4 class="accordion__title"style="margin-right: 20px;">داستان ما</h4>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="accordion__panel">
                                                <div class="accordion__heading" id="heading-3">
                                                    <a data-toggle="collapse" href="#collapse-3" class="accordion__link" aria-expanded="true" aria-controls="collapse-3">
                                                        <span class="accordion__toggle"></span>
                                                        <h4 class="accordion__title"style="margin-right: 20px;">چگونه کار می کنیم </h4>
                                                    </a>
                                                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="title-row text-center">
                                <h2 class="section-title">دوستان ما</h2>
                ...
                <div class="projects-slider">
                        ...
                        <article class="project project-slide hover-shrink">
                            <a href="single-project.html" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                                    <img src="img/works/project_slide_1.jpg" class="project__img hover-shrink--zoom" alt="project 1">
                                </figure>
                            </a>
                    ...
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a href="single-project.html" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                                    <img src="img/works/project_slide_2.jpg" class="project__img hover-shrink--zoom" alt="project 2">
                                </figure>
                            </a>
                            <div class="project__description-wrap">
                                <div class="project__description">
                    ...
                    <div class="flickity-slide">
                        <article class="project project-slide hover-shrink">
                            <a href="single-project.html" class="project__url">
                                <figure class="project__img-holder hover-shrink--shrink">
                                    <img src="img/works/project_slide_3.jpg" class="project__img hover-shrink--zoom" alt="project 3">
                                </figure>
                            </a>
                            <div class="project__description-wrap">
                                <div class="project__description">
